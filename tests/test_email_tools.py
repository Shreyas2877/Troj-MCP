...
class TestSendEmailViaService:
    ...
    def test_send_email_via_service_success(self, mock_post):
        ...
        result = _send_email_via_service("test@example.com", "Test Subject", "Test Body")
...
class TestSendEmail:
    ...
    def test_send_email_success_without_elaboration(self, mock_send_service):
        ...
        mock_send_service.assert_called_once_with("test@example.com", "Test Subject", "Test body")
    ...
    def test_send_email_elaboration_failure(self, mock_send_service, mock_elaborate):
        ...
        mock_elaborate.side_effect = ValidationError("Elaboration failed", field="brief_text")
